...
const HIGH_RISK_VERIFICATION_RE = /(?:今|現在|今日|明日|最新|直近|価格|値段|相場|在庫|発売|販売中|営業(?:中|時間)?|運行|遅延|運休|時刻表|乗換|乗り換え|電車|鉄道|列車|新幹線|特急|天気|天候|為替|法律|法令|制度|規制|社長|CEO|首相|大統領|ニュース|バージョン|対応|互換|使え|BIOS|UEFI|ファームウェア|ドライバ)/i;
