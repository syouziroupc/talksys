...
`        webSearch: true,
        ...
        bingRssEnabled: true,`,
    'health web fields');
  s = replaceOnce(s, `        searchGapDrivenFollowups: false,`, `        searchGapDrivenFollowups: true,`, 'health gap flag');
  s = replaceOnce(s, `        searchEngineRotation: false,\n        searchEngineRetry: false,`, `        searchEngineRotation: true,\n        searchEngineRetry: true,`, 'health engine flags');
  s = replaceOnce(s, `        specializedSearchRoutesPreserved: false,`, `        specializedSearchRoutesPreserved: true,`, 'health specialized flag');

  write(path, s);
}

// ---- behavioral regression tests ----
write('tests/v45-search-restoration.test.mjs', `import test from 'node:test';
import assert from 'node:assert/strict';
import {
  SEARCH_V45_GENERAL_WEB_SEARCH_ENABLED,
  SEARCH_V44_MAX_ENGINE_RETRIES,
  SEARCH_V45_PROVIDER,
  __test as searchTest,
