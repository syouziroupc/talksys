...
test('v97 web client clears stale interaction state while Discord remains current V99 bridge', () => {
  ...
  assert.match(discord, /talksys-discord-bridge-v99-stale-stt-drop-r1/);
});
