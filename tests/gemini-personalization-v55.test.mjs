...
test('v97 web client clears stale interaction state while Discord remains current V102 bridge', () => {
  ...
  assert.match(discord, /talksys-discord-bridge-v102-barge-generation-guard-r1/);
});
