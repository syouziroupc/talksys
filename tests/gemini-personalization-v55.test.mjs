...
test('v97 web client clears stale interaction state while Discord remains current V98 bridge', () => {
  ...
  assert.match(discord, /talksys-discord-bridge-v98-latency-error-r1/);
});
