...
test('v97 web client clears stale interaction state while Discord remains current V100 bridge', () => {
  ...
  assert.match(discord, /talksys-discord-bridge-v100-resolved-stt-order-r1/);
});
