...
test('v97 web client clears stale interaction state while Discord remains current V101 bridge', () => {
  ...
  assert.match(discord, /talksys-discord-bridge-v101-eou-fast-reaction-r1/);
});
