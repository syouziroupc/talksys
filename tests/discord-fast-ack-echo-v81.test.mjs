...
test('current V103 Discord bridge preserves authoritative Whisper while current Worker keeps its own revision', () => {
  assert.match(bridge, /talksys-discord-bridge-v103-contextual-jp-stt-r1/);
