...
test('exact V92 Discord bridge preserves authoritative Whisper while current Worker keeps its own revision', () => {
  assert.match(bridge, /talksys-discord-bridge-v92-empty-transcript-entity-search-r1/);
