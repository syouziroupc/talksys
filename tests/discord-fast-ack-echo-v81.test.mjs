...
test('current V102 Discord bridge preserves authoritative Whisper while current Worker keeps its own revision', () => {
  assert.match(bridge, /talksys-discord-bridge-v102-barge-generation-guard-r1/);
