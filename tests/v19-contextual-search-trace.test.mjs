...
test('v19 planner-first search remains available as rollback while v20.2 owns production', () => {
  ...
  assert.match(workerV20, /conversationOrchestrator: 'tiered-fast-agent-v20\.2'/);
  assert.match(workerV20, /toolCalling: 'deterministic-search-router-v20\.2'/);
