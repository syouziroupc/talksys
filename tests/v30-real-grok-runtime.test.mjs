...
test('v30 rollback never lets browser streaming TTS suppress Grok server audio', () => {
...
test('v30 rollback disables audible browser speech fallback', () => {
...
test('v30 rollback typed simulation routes completed text to server Grok TTS', () => {
...
test('v30 rollback Grok startup budget no longer aborts at 1.55 seconds', async () => {
...
test('v30 rollback health source declares its former Grok audio contract', async () => {
...
test('v30 remains available only as rollback after v31 selection', async () => {
